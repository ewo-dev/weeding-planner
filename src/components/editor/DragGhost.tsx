 ...
 * `shadow-lg`, slight rotation for feel. Guests show the card chip;
 * tables show a compact label card with occupancy.
 */
export function DragGhost(props: DragGhostProps) {
  if (props.kind === 'table') {
    return (
      <div className="rotate-1 scale-105 rounded-lg border border-border bg-surface-raised px-4 py-2 shadow-lg">
  ...
  return (
    <div className="flex rotate-1 scale-105 items-center gap-2 rounded-full border border-border bg-surface-raised py-1 pl-1 pr-3 shadow-lg">
